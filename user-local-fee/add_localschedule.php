              ...
              if($_SESSION['role'] == 'officer'){?>
               ...
               <i class="fa fa-caret-down" style = "margin-left:70px;"></i>
                ...
                <div class="dropdown-container">
                    ...
                    <a href="../user-local-fee/local-fee.php"class="list-group-item list-group-item-action bg-hover first-text fw-bold active"  style="text-decoration:none; padding-left: 70px;">Local Fees</a>
                </div>            
                <?php } ?>
...
<!-- Dashboard hamburger      -->
    <nav class="navbar navbar-expand-lg navbar-light bg-active py-4 px-4">
        <div class="d-flex align-items-center">
            ...
            <h2 class="fs-2 m-0">Add Local Fees</h2>
        </div>
    </nav>
