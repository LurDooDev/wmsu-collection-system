              ...
              if($_SESSION['role'] == 'officer'){?>
               ...
               <i class="fa fa-caret-down" style = "margin-left:70px;"></i>
                ...
                <div class="dropdown-container">
                    ...
                    <a href="../admin-settings-user/local-fee.php"class="list-group-item list-group-item-action bg-hover first-text fw-bold active"  style="text-decoration:none; padding-left: 70px;">Local Fees</a>
                </div>            
                <?php } ?>
