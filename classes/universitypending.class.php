...
class UniversityPending {
    ...
    function getFeeById($feeId) {
        $sql = "SELECT up.id, up.student_id, up.university_fee_id, up.pending_amount, up.university_status, uf.fee_type, uf.fee_name, ay.academic_name, ss.semester_name, s.first_name, s.last_name
