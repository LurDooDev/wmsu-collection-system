<?php
  ...
  if (!isset($_SESSION['logged_id'])) {
    header('location: ../user-univ-fee/new-univer-fee.php');
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="../admin-settings-user/admin-settings-user.php" class="list-group-item list-group-item-action bg-hover first-text fw-bold" style="text-decoration:none; padding-left: 70px;">Overview</a></ul>
                    <a href="../user-univ-fee/new-univer-fee.php" class="list-group-item list-group-item-action bg-hover first-text fw-bold active " style="text-decoration:none; padding-left: 70px;">University Fee</a></ul>
					...
					<div class="row">
						<div class="col-sm-6">
							...
							<div class="form-group">
								...
								<input type="text" name="feeName" id="feeName" class="form-control" required aria-describedby="name-description" placeholder="CSC Fee">
