    ...
    <div class="table-responsive" id="studentTable">
        <div class="row my-2 mx-1 justify-content-center" style="display: block;">
            <table class="table table-striped table-borderless"  id="students-table">
                <thead style="background-color:#95BDFE ;" class="text-white">
                    <tr>
                        ...
                        <th scope="col" style="color: #000000; text-align:center">Student ID</th>
                        <th scope="col" style="color: #000000; text-align:center">College</th>
                        <th scope="col" style="color: #000000;text-align:center">Course</th>
            ...
            <tr>
              ...
              <a href="../new-payment/payment.php" class="status"><i class="far fa-address-card" style="color: #7C0A02; font-size:1.5rem;"></i></a>
              </td>
            </tr>
                </tbody>
            </table>
