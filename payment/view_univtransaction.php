...
<div class="table-responsive">
    ...
    <div class="page-header text-blue-d2">
        ...
        <a href="../payment/universitypayment.php" class="arrow-icon" ><i class="fas fa-arrow-left"></i></a>  
        </div>
    </div>
    <div class="row">
                    <div class="col-sm-6">
...
<div class="d-flex">
          <div class="ml-auto p-auto">
            <a href="../payment/universitypayment.php" class="btn btn-success" id="backstreet" style="border-radius: 40px; padding: 10 10 10 10;"> <span>Pay Balance Now</span></a>
