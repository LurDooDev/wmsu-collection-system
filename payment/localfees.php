        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <div class="dropdown-container">
                    ...
                    <a href="localpayment.php" class="list-group-item list-group-item-action bg-hover first-text fw-bold active " style="text-decoration:none; padding-left: 70px;">Local Payment</a>
                </div>
				...
				<div class="">
					<form id="form">
						<ul id="progressbar">
							...
							<li class ="active" id="step2"><strong>Local Fees</strong></li>
...
<div class="d-flex">
                <div class="mr-auto">
                <a href="localpayment.php" class="btn btn-success"><span>Previous </span></a>
					</div>
          <div class="ml-auto p-auto">
            <a href="local-details.php" class="btn btn-success" id="backstreet"> <span>Pay</span></a>
