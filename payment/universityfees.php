...
<div class="d-flex">
                <div class="mr-auto">
                <a href="universitypayment.php" class="btn btn-success" style="border-radius: 40px; padding: 10 10 10 10;"><span>Previous </span></a>
					</div>
          <div class="ml-auto p-auto">
            <a href="university-details.php" class="btn btn-success" id="backstreet" style="border-radius: 40px; padding: 10 10 10 10;"> <span>Proceed To Payment</span></a>
