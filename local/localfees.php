...
<!-- Dashboard hamburger      -->
    <nav class="navbar navbar-expand-lg navbar-light bg-active py-4 px-4">
        <div class="d-flex align-items-center">
            ...
            <h2 class="fs-2 m-0" style="color:#000000; font-weight: 400;"><?php echo $collegename?> Fee</h2>
        </div>
    </nav>
    <div class="container">
...
$FeeData = $Fee->showAllDetailsByCollegeID($collegeid);
...
<div id="addCollectorModal" class="modal fade">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<form action="addlocalfees.php" method="POST">
				<div class="modal-header">						
					<h4 class="modal-title">Add <?php echo $collegecode?> Fees</h4>
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				</div>
				<div class="modal-body">
    <div class="row">
        ...
        <div class="col-sm-6">
          ...
          <input type="hidden" name="created_by" value="<?php echo $fullname; ?>">
					<input type="submit" class="btn btn-success" value="Save">
				</div>
			</form>
		</div>
